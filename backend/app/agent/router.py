...
_SYSTEM = (
    ...
    "When you answer a clinical question, mirror the tool's structure: state the answer, "
    "the reason, the confidence, what's missing, and a suggested next step framed 'for "
    "your review'. Never state a diagnosis or treatment beyond the cited evidence.\n\n"
